    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 p-6 md:-mt-24">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <form action={action} className="space-y-5">
          <div>
            ...
            <input 
              ...
              type="text" 
              required
              className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:border-zinc-800 focus:ring-0 transition-colors focus:outline-none font-medium"
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          Already have an account? <Link href="/login" className="text-zinc-900 font-bold hover:underline">Sign In here</Link>
        </p>
      </div>
    </div>
  );
